...
export default function User() {
  ...
  const UserInfo = () => {
    ...
    //          state: 닉네임 상태         //
    const [nickname, setNickname] = useState<string>("easyhoon");
    //          state: 닉네임 변경 상태         //
      ...
      <div id="user-info-wrapper">
        <div className="user-info-container">
          <div
            className={
              isMyPage
                ? "user-info-profile-image-box-mypage"
                : "user-info-profile-image-box"
            }
          ...
          <div className="user-info-meta-box">
            <div className="user-info-nickname-box">
              {showChangeNickname ? (
                <input
                  className="user-info-nickname-input"
                  type="text"
              ...
              {isMyPage && (
                <div
                  ...
                  onClick={onChangeNicknameButtonClickHandler}
                >
        ...
        <div className="user-board-container">
          <div className="user-board-title-box">
            <div className="user-board-title">
              {"내 게시물 "} <span className="emphasis">{" " + count}</span>{" "}
            </div>
          </div>
          <div className="user-board-contents-box">
            {count === 0 ? (
              ...
              <div className="user-board-contents-result-box">{viewBoardList.map(boardItem => <BoardListItem boardItem={boardItem}/>)}</div>
            )}
            <div className="user-board-button-box" onClick={onButtonClickHandler}>
              <div className="user-board-button-contents">
                {isMyPage ? (
                  ...
                  <>
                    <div className="user-board-button-text">
                      {"내 게시물로 가기"}
                    </div>
                    <div className="icon-box">
