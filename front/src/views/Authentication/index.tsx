...
export default function Authentication() {
  ...
  const SignInCard = () => {
    ...
    const onSignInButtonClickHandler = () => {
      // TODO: 로그인 처리 API 연결
      const isSuccess =
        email === loginInfoMock.email && password === loginInfoMock.password;
      if (!isSuccess) {
        setError(true);
        return;
      }
      ...
      <div className="auth-card">
        <div className="auth-card-top">
          ...
          <InputBox
            ...
            icon={passwordIcon}
            onButtonClick={onPasswordIconClickHandler}
        ...
        <div className="auth-card-bottom">
          ...
          <div className="auth-button" onClick={onSignInButtonClickHandler}>
            {"로그인"}
          </div>
  ...
  const SignUpCard = () => {
    ...
    return (
      <div className="auth-card">
          ...
          {page === 2 && (
            <>
              ...
              <InputBox
                ...
                onButtonClick={onAddressIconClickHandler}
              />
              <InputBox
                label="상세 주소"
                type="text"
        ...
        <div className="auth-card-bottom">
          {page === 1 && (
            <div className="auth-button" onClick={onNextStepButtonClickHandler}>
              {"다음 단계"}
            </div>
          )}
          {page === 2 && (
